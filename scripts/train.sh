...
torchrun --nnodes $WORLD_SIZE \
    ...
    --val_data_path /n/work1/muyun/Dataset/datasets_v3/labels/config_mm_val.json \
    --subset train \
    --dataloader_num_workers 4 \
    --model_type SilenceQwen3 \
    ...
    --output_dir /n/work1/muyun/Model/audio_video/SilenceQwen3-1.7B-lora16-siglip2-linear-no_sr-concat-float32 \
    --adam_beta2 0.98 \
