...
class SilenceLlama3Config(LlamaConfig):
    model_type = "silence_llama3"
    
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.model_type = "silence_llama3"
        
class SilenceLlama3Model(SilenceMetaModel, LlamaModel):
    config_class = SilenceLlama3Config
    
    def __init__(self, config):
        super().__init__(config)


class SilenceLlama3ForCausalLM(LlamaForCausalLM, SilenceMetaForCausalLM):
    config_class = SilenceLlama3Config
    
    def __init__(self, config, **kwargs):
        super().__init__(config)
        self.model = SilenceLlama3Model(config)
...
AutoConfig.register("silence_llama3", SilenceLlama3Config)
AutoModelForCausalLM.register(SilenceLlama3Config, SilenceLlama3ForCausalLM)
